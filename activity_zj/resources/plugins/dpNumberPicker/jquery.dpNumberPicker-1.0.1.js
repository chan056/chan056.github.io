...
;(function($){
	$.fn.dpNumberPicker = function(){
		...
		this.each(function(){
			var element = this;
			var np = $(this);
			var s = "<span class='dp-numberPicker-sub'>"+element.options.subText+"</span><input type='text' class='dp-numberPicker-input'"
			...
			s += "/><span class='dp-numberPicker-add'>"+element.options.addText+"</span>";
